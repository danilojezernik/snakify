...
In the 1_input_print_and_numbers test there are three groups. The 1_input_print_and_numbers group has 20 students and thus needs 10 desks.
The 2_integer_and_float_numbers group has 21 students, so they can get by with no fewer than 11 desks.
